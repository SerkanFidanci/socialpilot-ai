...
| [W06](handoffs/W06-runtime-images-and-backup.md) | **Çalışma zamanı imajları + yedek runner'ı** — PG/Valkey sürüm geçişi (sürüm doğrulanacak, varsayılmayacak) + `--profile backup` ile çalıştırılabilir yedek + gerçek geri yükleme provası · **D1 kapısını kapatır** | **şimdi** | `slice/0j-runtime-images` | Opus 4.8 / medium | — |
