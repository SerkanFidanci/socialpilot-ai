...
| [W12](handoffs/W12-verification-followups.md) | **Doğrulama bulgularının kapatılması** — katı parasal tamsayı tipi · trace zincirinin worker'a taşınması | **tamamlandı** · merge + bağımsız doğrulama bekliyor · 412 test (392 → +20), migration yok, head değişmedi · PM'e 5 kalem bırakıldı (modül `CLAUDE.md`'leri, ADR-014 metni) | `slice/0n-verification-followups` | Opus 5 / high | — |
