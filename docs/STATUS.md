...
| [W09](handoffs/W09-real-media-materializer.md) | **Gerçek medya materializer + `.mov`/HEVC analiz kapısı** — Phase 1 çıkış kriterinin kalan yarısı | **tamamlandı** · doğrulama/merge bekliyor · ADR-009 indekse eklenecek (PM) | `slice/1g-real-materializer` | Opus 4.8 / high | — |
