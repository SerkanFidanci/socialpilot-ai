...
| | |
|---|---|
| `main` | W01→W20 merge edildi — **Phase 2'nin 2A–2E'si tamam**. **W21 (2F onay + revizyon) dalda tamamlandı, merge bekliyor.** Sırada 2G (planlayıcı). W20 ve W21 için Codex turu bekliyor |
| Alembic head | `0018_approval_and_revision` (dalda; tek head, zincir 0001→0018, up/down/up doğrulandı) · `main`'de `0017_entitlement_ledger` |
