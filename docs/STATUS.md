...
| | |
|---|---|
| `main` | W01→W17 merge edildi, yalnız W06 bekliyor. **İki sıcak oturum açık:** W18 (2D QC) Celery bağlantısını bekliyor (dalda, 1071 pytest) · W17 takip 2 **tamamlandı** (`2ee0f3b`, dalda: sayı birleşimleri gramerle, `T Lye` kapalı ek kümesiyle; **1020 pytest**, 111.129 varyantlık taramada 0 kaçış) — merge ve doğrulama bekliyor |
...
| [W17](handoffs/W17-latin-fold-pattern-grammar.md) | **Latin katlaması + kalıp grameri + Türkçe çekim** | iki tur merge edildi (947 pytest) · Codex takip-1 turu: çekim çapası tuttu (161/161 ek, 12/12 yanlış pozitif temiz) ama yazılı sayı gramerinde 3 açık → **takip düzeltmesi 2 tamamlandı** (`2ee0f3b`, dalda): sayı sözcükleri liste + birleşimleri gramer (bitişik/tireli dahil), `T Lye` kapalı Türkçe ek kümesiyle, **1020 pytest**, 111.129 varyantlık kendi taramamda 0 kaçış — merge edilmedi, doğrulama bekliyor | `fix/w17-latin-fold` (sıcak oturum) | Opus 5 / high | — |
