...
| | |
|---|---|
| `main` | W01→W22 merge edildi — **PHASE 2 TAMAM (2A–2G)**, 1459 test yeşil. **Bağımsız doğrulama turu döndü:** W21 ve W22 temiz (7/7, 7/7); **W20'de 3 defter bütünlüğü açığı → W23** (negatif bakiye ham yazarla aşılıyor, ikinci iade yazılabiliyor, kaynak başına çift rezervasyon) |
...
| [W23](handoffs/W23-ledger-integrity.md) | **Defter bütünlüğü** — doğrulama turunun W20'de bulduğu üç açık: negatif bakiye trigger'ı eşzamanlı ham yazarla aşılıyor, aynı rezervasyona ikinci iade yazılabiliyor (para yaratılıyor), `reserve` kaynak başına tekilleştirmiyor. Koruma **şemaya** taşınacak | **şimdi** | `fix/ledger-integrity` | Opus 5 / high | **SENDE** (`0020`) |
