...
- **`docs/index.md` / `docs/adr/README.md`** — sahibi W03. **ADR-009 indekslere eklenmedi.**
  Bağlanacak satır: `ADR-009 — Gerçek medya materializer + .mov/HEVC analiz kapısı` →
  `docs/adr/ADR-009-real-media-materializer.md`. PM bağlar.
