# ADR-014: OpenTelemetry Observability Foundation (Trace + Metric, Default OFF)
...
> Numarayı PM merge sırasında verir; dosya adında ve başlıkta `ADR-014` bilinçli bırakıldı.
