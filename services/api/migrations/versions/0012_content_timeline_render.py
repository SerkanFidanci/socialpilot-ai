...
**Chain note (resolved at merge).** Authored on a branch as `0010_brand_catalog` because W10
had not merged when this branch was cut. W10 owns slot `0011_schema_debt`. Whoever merges
second; the PM re-pointed `down_revision` to `0011_schema_debt` at merge so the chain stays
...
down_revision: str | None = "0011_schema_debt"
